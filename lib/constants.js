...
export const SOCIAL_LINKS = {
  github: 'https://github.com/mhmdrzkyystiawnn',
  instagram: 'https://instagram.com/rizkyystiawann',
  email: 'mhmdddrzkyyyy@gmail.com',
};
...
export const FEATURES = {
  cursorTrail: true,      // Matikan untuk mobile/performance
  easterEgg: true,        // Matikan jika tidak mau confetti
  darkMode: false,        // Siap untuk dark mode toggle
  analytics: false,       // Siap untuk analytics integration
};