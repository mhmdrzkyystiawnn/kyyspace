...
export const projects = [
  {
    ...
    category: "weather",
    icon: "🌤️",
    url: "https://cuaca-hari-ini.vercel.app",
  ...
  },
  {
    ...
    category: "anime",
    icon: "🎌",
    url: "https://anime-list-kyy.vercel.app",
  ...
  },
  {
    ...
    category: "movie",
    icon: "🎬",
    url: "https://movie-list-ikiw.vercel.app",
  ...
  },
  {
    ...
    category: "prayer",
    icon: "🕌",
    url: "https://jadwal-shalat-terbaru.vercel.app",
    apiUrl: "https://api.aladhan.com/v1/timingsByCity",
    screenshot: "/screenshots/prayer-times.png",
    tech: ["Html", "Css", "Javascript", "Aladhan API", "Geolocation", "Notifications"],
  },
];
